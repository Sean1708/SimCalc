...
sc: lex.l parse.y read.c read.h base.c base.h uservar.c uservar.h loadlib.c loadlib.h command.h command.c logging.c sc.c
	...
	$(CC) $(CFLAGS) $(LIBS)  parse.o lex.o read.o base.o uservar.o loadlib.o command.o logging.o src/sc.c  -o bin/sc
	rm lex.c lex.h lex.o parse.c parse.h parse.o read.o base.o uservar.o loadlib.o command.o logging.o
